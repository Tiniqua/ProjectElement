...
/** Custom property type to provide a drop down list of all TableRow child structures for selection. */
class FTableRowSelectorCustomization : public IPropertyTypeCustomization
{
...
public:
	...
	{
		return MakeShareable(new FTableRowSelectorCustomization());
	}
