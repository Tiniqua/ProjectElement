...
struct FEOSAntiCheatCommonClientHandle
{
	GENERATED_BODY()
public:
	explicit FEOSAntiCheatCommonClientHandle()
		: m_Handle(nullptr) {}
public:
	FEOSAntiCheatCommonClientHandle(const EOS_AntiCheatCommon_ClientHandle& handle)
		: m_Handle(handle)
	{}
private:
	EOS_AntiCheatCommon_ClientHandle m_Handle;
public:
